...
// -----------------------------------------------------------------------------------------------
// Hardcoded parameter (These parameters can be overwritten by creating the file /$DATADIR/options.php)
...
if (!is_writable(dirname($_SERVER["SCRIPT_FILENAME"]))) die('<pre>ERROR: Shaarli does not have the right to write in its own directory ('.dirname($_SERVER["SCRIPT_FILENAME"]).').</pre>');
...
if (!is_file($GLOBALS['config']['DATADIR'].'/.htaccess')) die('<pre>ERROR: Shaarli does not have the right to write in its data directory ('.$GLOBALS['config']['DATADIR'].').</pre>');
